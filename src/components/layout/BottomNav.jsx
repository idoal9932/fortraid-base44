...
export default function BottomNav({ role }) {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 safe-area-bottom" style={{ background: "#0a1628", borderTop: "1px solid #1e3a5f" }}>
      <div className="flex items-center justify-around h-16 max-w-lg mx-auto">
        {tabs.map((tab, idx) => {
          ...
          return (
            ...
            >
              <div className="p-1.5 rounded-xl transition-all duration-200" style={isActive ? { background: "rgba(45,212,191,0.1)" } : {}}>
